...
extension SettingsView {
    ...
    private func makeSecondButtonView(buttonType: Int, text: String) -> some View {
        if buttonType == 0 {
            HStack { Text(text); Text("A").font(.aiachyFont(.cinzelBold14)) }
    ...
    var settingsSections: some View {
        VStack(spacing: 15) {
            ...
            ACYDualButton(settingsLogo: .aicyCashLogo,
                          firstText: TextHandler.makeSettingsString(aiachy: aiachyState, settings: .aicyCashTitle))
        ...
        secondAction: { }
            ...
            ACYDualButton(settingsLogo: .oracleLogo,
                          firstText: TextHandler.makeSettingsString(aiachy: aiachyState, settings: .oracleTitle))
        ...
        secondAction: { }
            ...
            ACYDualButton(settingsLogo: .languageLogo,
                          firstText: TextHandler.makeSettingsString(aiachy: aiachyState, settings: .languageTitle))
        ...
        secondAction: { }
            ...
            ACYDualButton(settingsLogo: .themeLogo,
                          firstText: TextHandler.makeSettingsString(aiachy: aiachyState, settings: .themeTitle))
