    ...
    private var oracleSection: some View {
        HStack {
            ...
            Text(TextHandler.makeSettingsOracleString(aiachy: aiachyState, oracle: .packageZodiacTitle))
                .underline(presenter.currentIndex == 0, color: Color(ColorHandler.makeAiachyColor(aiachyState, aiachyColor: .fifthColor)))
                .onTapGesture {
            ...
            Text(TextHandler.makeSettingsOracleString(aiachy: aiachyState, oracle: .packageOracleTitle))
                .underline(presenter.currentIndex == 1, color: Color(ColorHandler.makeAiachyColor(aiachyState, aiachyColor: .fifthColor)))
                .onTapGesture {
                    withAnimation(.linear) {
    ...
    private var oracleZodiac: some View {
        ZStack {
            ...
            VStack {
                ...
                Image(ImageHandler.makeSettingsOracleString(aiachyState, oracle: .oracleOccult))
                    .resizable()
                    .scaledToFit()
    ...
    func makeOracleItem(_ item: TextHelper.SettingsCompletion.oracle) -> some View {
        VStack(spacing: 0) {
            ...
            Text(TextHandler.makeSettingsOracleString(aiachy: aiachyState, oracle: item))
                .foregroundStyle(Color(ColorHandler.makeAiachyColor(aiachyState, aiachyColor: .backgroundAlternativeColor)))
                .font(FontHandler.aiachyFont(.roundedBold16))
